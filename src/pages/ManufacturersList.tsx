...
const ManufacturersList: React.FC<ManufacturersListProps> = ({ setCurrentPage }) => {
  ...
  const manufacturers = [
    { id: 'nanocure', name: 'NanoCure Tech Korea', logo: '' },
    { id: 'dentalpro', name: 'DentalPro Innovations', logo: '' },
    { id: 'oraltech', name: 'OralTech Solutions', logo: '' },
    { id: 'dentacare', name: 'DentaCare Systems', logo: '' },
    { id: 'smiletech', name: 'SmileTech Dental', logo: '' }
  ];
              ...
              >
                <div className="p-4 md:p-6">
                  ...
                  <p className="text-gray-600 text-xs md:text-sm">
                    Click to learn more about our partnership with {manufacturer.name}
                  </p>
                </div>
              </div>
            ))}
