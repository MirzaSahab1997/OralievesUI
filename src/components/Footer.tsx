    ...
    <footer className="bg-gradient-to-r from-oralieves-dark to-oralieves-primary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Privacy Policy */}
          <div>
            <h5 className="font-semibold mb-4">Privacy Policy</h5>
            <ul className="space-y-2 text-oralieves-light">
          ...
          {/* Newsletter Signup */}
          <div>
            <h5 className="font-semibold mb-4">Newsletter Signup</h5>
            <p className="text-oralieves-light text-sm mb-4">Subscribe to get updates on our latest products and offers</p>
            <form className="space-y-3">
              ...
              <button 
                type="submit" 
                className="w-full bg-white text-oralieves-primary font-semibold py-2 px-4 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/20 pt-8 text-center text-oralieves-light">
